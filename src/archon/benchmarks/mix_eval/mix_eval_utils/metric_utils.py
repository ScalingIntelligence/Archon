...
import numpy as np
import ast
from .judge_freeform_parser import (
    ArchonJudgeCloseendFreeform
    )
from .judge_multichoice_parser import (
    ArchonJudgeCloseendMultichoice
    )
...
def parse_multi_choice_response_model(args, tasks):
    ...
    tasks_judged = []
    model_judge = ArchonJudgeCloseendMultichoice(args)
...
def parse_freeform_response_model(args, tasks):
    tasks_remained = tasks
    tasks_judged = []
    model_judge = ArchonJudgeCloseendFreeform(args)
